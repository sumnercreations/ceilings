...
export class SwoonGridComponent implements OnInit {
  ...
  ngOnInit() {
    // subscribe to the buildSwoonGrid event
    this.debug.log('swoon-grid-component', 'subscribing to buildSwoonGrid event');
    this.feature.onBuildSwoonGrid.subscribe( result => {
      this.debug.log('swoon-grid-component', 'buiding the swoon grid');
      this.renderGrid();
    });
  }
